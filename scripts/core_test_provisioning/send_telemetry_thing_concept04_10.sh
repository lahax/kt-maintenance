...
mosquitto_pub  -h $IOT_HOST -p 8883 -t esol_ap29551_qa/Test_Concept-04/mqtts/Test_Concept-04_thing2/data --cert $CERT --cafile $CA --key $KEY  -d -i 'esol_ap29551_qa_Test_Concept-04_thing2' -q 1 -f ./payload_telemetry_test_concept_04_10.txt
sleep 1
done