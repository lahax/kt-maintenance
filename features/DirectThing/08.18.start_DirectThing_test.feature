...
Feature: Direct Thing
  ...
  Scenario: Test case 8.18 start
    ...
    And I cancel text from the input box element DevicesPage.searchBox
    Then I input "DirectThingConcept2" in DevicesPage.searchBox
    #Then I check the presence of DevicesPage.directThingDetails Element and then i click it
    Then I check the presence of details icon for the specific Devices "DirectThingConcept2" and then I click it
    ...
    Then I check the presence of DevicesDetailsPage.deploymentStartRange Element and then i click it
    And I check the presence of DevicesDetailsPage.leftMonthBTNFrom Element and then i click it
    And I check the presence of DevicesDetailsPage.fifteenthDayPreviousMonthFrom Element and then i click it
    And I check the presence of DevicesDetailsPage.toTabsIntoCalendar Element and then i click it
    And I check the presence of DevicesDetailsPage.buttonNowIntoCalendar Element and then i click it
    And I check the presence of DevicesDetailsPage.buttonConfirmIntoCalendarStart Element and then i click it
