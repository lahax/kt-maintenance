@E2EMonitoring_Test_15.12_HigherThreshold
Feature: E2EMonitoring
  ...
  Scenario: Test 15.12 HigherThreshold
    ...
    And I type "5" into the element DeviceAlarmsConfigurationPage.visibleNumberOfMessage
    Then I check the presence of DeviceAlarmsConfigurationPage.dropDownArrowTAB Element and then i click it
    ...
    #Check Email
    Then I check message of "higher" notification in mail boxes, from device "Test_Concept-04" in the project "esol-ap29551-qa"
    #Check SMS
    ...
    Then I kill the notify_job command still opened
    #Check Email
    Then I check message of "alarm-cleared" notification in mail boxes, from device "Test_Concept-04" in the project "esol-ap29551-qa"
    #Check SMS
    #Then I check text "Test_Concept-04" is in sms boxes body
    Then I kill the notify_job command still opened
    Then I listen to MQTT topic given for "Test_Concept-04", in the project "esol_ap29551_qa"
    ...
    #Check Email
    Then I check message of "lower" notification in mail boxes, from device "Test_Concept-04" in the project "esol-ap29551-qa"
    #Check SMS
    #Then I check text "Test_Concept-04" is in sms boxes body
    #Check MQTT
