...
#-------------------------------------------------------------------------------------------------------------------
    ...
    #Then If present, I deactivate the "thing1" on "Test_Concept-01", in the project "esol_ap29551_qa"
    #Then If present, I deactivate the "thing2" on "Test_Concept-01", in the project "esol_ap29551_qa"
    #Then If present, I deactivate the "thing3" on "Test_Concept-01", in the project "esol_ap29551_qa"
    ...
    #And I check that MQTT is receiving a notification message with fields: "notification_type" and "source"
    ...
    #Check Email
    #Then I check message of "widspread disservice" notification in mail boxes, from device "Test_Concept-01" in the project "esol-ap29551-qa"
    ...
    #Then I check text "Test_Concept-01" is in sms boxes body
    #Check MQTT
    #And I check that MQTT is receiving a notification message with fields: "source" and "notification_type"
