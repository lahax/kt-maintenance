...
Feature: E2EMonitoring
  ...
  Scenario: Test 15.40
    ...
    Then I type " " into the element CustomGroupsPage.addDirectThingBox
...
#-------------------------------------------------------------------------------------------------------------------
    ...
    #Step 2
    #Maintain the devices disconnected for 3,5 minutes, then reconnect them
    And I kill the notify_job command still opened
    And I wait 210 seconds after script
    Then I connect the "thing3" of device "Test_Concept-01", in the project "esol_ap29551_qa", for 10 seconds, then disconnect it.
    Then I connect the "thing2" of device "Test_Concept-01", in the project "esol_ap29551_qa", for 10 seconds, then disconnect it.
    Then I connect the "thing1" of device "Test_Concept-01", in the project "esol_ap29551_qa", for 10 seconds, then disconnect it.
