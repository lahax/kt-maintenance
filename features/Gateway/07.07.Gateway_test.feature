...
Feature: Gateway
  ...
  Scenario: Test 7.7
    ...
    #Step 2
     #Use the same gateway of the previous test and use the filter "time":
    ...
    Then I check the presence of DevicesDetailsPage.leftMonthBTNFrom Element and then i click it
    Then I check the presence of DevicesDetailsPage.fifteenDayPreviousMonthFrom Element and then i click it
       #To now
    ...
    Then I check the presence of DevicesDetailsPage.confirmBTN Element and then i click it
