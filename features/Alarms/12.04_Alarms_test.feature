...
Feature: Alarms
  ...
  Scenario: Test case 12.4
    ...
    Then I check the presence of AlarmsPage.toTabsIntoCalendar Element and then i click it
    Then I check the presence of AlarmsPage.buttonNowIntoCalendar Element and then i click it
