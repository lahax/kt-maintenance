...
Feature: LandingPage
  ...
  Scenario: Test 3.6
    ...
    Then I check the presence of ProjectPage.thingDevicesNumber
    Then I check the presence of ProjectPage.thingDevicesPercentage
    Then I check the presence of ProjectPage.thingDevicesOnlineNumber
...
"aggs":{"by_environment_prefix":{"terms":{"field":"environment_prefix"}}}}}}}
    ...
    Then I check if values of "thing" in devices section are correct
