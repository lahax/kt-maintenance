...
Feature: LandingPage
  ...
  Scenario: Test 3.5
    ...
    Then I check the presence of ProjectPage.gatewayDevicesNumber
    Then I check the presence of ProjectPage.gatewayDevicesPercentage
    Then I check the presence of ProjectPage.gatewayDevicesOnlineNumber
...
"aggs":{"by_environment_prefix":{"terms":{"field":"environment_prefix"}}}}}}}
    ...
    Then I check if values of "gateway" in devices section are correct
