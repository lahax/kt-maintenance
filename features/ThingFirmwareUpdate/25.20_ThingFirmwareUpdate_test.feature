@ThingFirmwareUpdate_Test_25.20
Feature: Thing Firmware Update

   # https://confluence.springlab.enel.com/display/EXEGIPL/%5BEGIP+2021%5D+%5BEXEGIP2-35%5D+OCPP+Software+Update+-+Test+Guide+-+25.20
   # GOAL: The Deployment History item in progress change status to Failed.
   # Step 1
    #Login on DMC
  Background:
  ...
  Scenario: ThingFirmwareUpdate_Test_25.20
    ...
    Then I check the presence of DeploymentsHistoryPage.optionFailed Element and then i click it
