@29.23_DeploymentHistory_test
Feature: Deployment History

  #script

  #https://jira.springlab.enel.com/browse/EXEGIP2-1278
  ...
  Scenario: Deployment History 29.23
    ...
    And I input "2.0" in SoftwareCataloguePage.versionInput
    ...
    And I wait the progress bar
    Then I input "Gateway29-Concept1 " in DevicesPage.searchBox
    Then  I launch command "bash ./register.sh ax3v62h9b8tp2.iot.eu-central-1.amazonaws.com esol_ap29551_qa Gateway29-Concept1 ./payload_gateway_software29_23.txt" on shell
    ...
    And I check the presence of DevicesDetailsPage.version2OptionToSelect Element and then i click it
    ...
    And I run the script "close_job_software_29_23", with the job Id retrieved, on "Gateway29-Concept1" in the project "esol_ap29551_qa"
    Then I kill the notify_job command still opened
    ...
    And I check the presence of DeploymentHistoryDeviceDetailsPage.packageInstallationOutcome2923
    ...
    Then I check the presence of DevicesPage.testSoftware23
